  ...
  public async start() {
    ...
    await server.register(
      async (instance) => {
        ...
        await instance.register(this._crm.reorderDealStages)
        await instance.register(this._crm.updateDealStage)
        await instance.register(this._crm.deleteDealStage)
        ...
        await instance.register(this._crm.getReports)
        ...
        await instance.register(this._crm.updateQuote)
        await instance.register(this._crm.deleteQuote)
        await instance.register(this._crm.getInvoices)
        await instance.register(this._crm.createInvoice)
        await instance.register(this._crm.updateInvoice)
        await instance.register(this._crm.deleteInvoice)
